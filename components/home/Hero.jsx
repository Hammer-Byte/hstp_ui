...
export default function Hero() {
  return (
    <div className="relative w-full h-[400px] lg:h-[600px] bg-gradient-to-br from-[var(--color-brand-primary)] to-[var(--color-brand-secondary)] flex items-center px-6 lg:px-12 pb-12 overflow-hidden">
