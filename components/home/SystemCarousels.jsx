...
import { SYSTEM_DATA } from "@/app/(app)/constant";
...
export default function SystemCarousels() {
  ...
  return (
    <section className="w-full flex flex-col gap-4">
      <h2 className="text-text-main">
        Hospitality <span className="text-primary">Systems Courses</span>
      </h2>
